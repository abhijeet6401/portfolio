  ...
  return (
    <div className="py-12 md:py-20">
      <div className="container-editorial">
        {/* Top Section: Bio + Lead Portrait */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start pb-16 border-b border-[#C8C3B8]">
          {/* Narrative Column */}
          ...
          {/* Lead Portrait Column */}
          <div className="lg:col-span-5">
            <figure className="bg-[#FAF8F2] border border-[#C8C3B8] p-3 rounded-sm shadow-xs sticky top-28">
              <div className="relative aspect-[3/4] w-full overflow-hidden bg-[#F3F0E8] rounded-xs">
                <Image
                  src="/images/abhijeet-portrait.png"
                  alt="Portrait of Abhijeet Kumar"
                  fill
                  priority
              ...
              <figcaption className="mt-3 px-1 text-xs text-[#66645E] leading-normal flex items-center justify-between">
                <span>Abhijeet Kumar · Product Builder</span>
        ...
        <div className="my-20">
          <div className="flex items-center justify-between mb-8 pb-3 border-b border-[#C8C3B8]">
            <div>
              <span className="font-mono text-xs uppercase tracking-widest text-[#A7472A] font-semibold">
                Documentary Texture
              </span>
              <h2 className="font-serif text-2xl sm:text-3xl text-[#1D1D1B] mt-1">
                Campus Teams, Operations &amp; Travel
              </h2>
            </div>
            <span className="font-mono text-xs text-[#66645E] hidden sm:inline-block">
              Photographic proof of execution
            </span>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <figure className="bg-[#FAF8F2] border border-[#C8C3B8] p-3 rounded-sm">
              <div className="relative aspect-[4/3] w-full overflow-hidden bg-[#F3F0E8]">
                <Image
                  src="/images/kgp-team-community.png"
                  alt="IIT Kharagpur team cohort in blue polo shirts with Abhijeet sitting front center"
                  fill
              ...
              <figcaption className="mt-3 px-1 text-xs text-[#66645E] leading-normal flex items-start justify-between gap-2">
                <span>
                  IIT Kharagpur student team &amp; cohort: cross-functional execution and campus leadership.
                </span>
                <span className="font-mono text-[10px] text-[#A7472A] shrink-0">
                  IIT KGP
                </span>
              </figcaption>
            </figure>
            ...
            <figure className="bg-[#FAF8F2] border border-[#C8C3B8] p-3 rounded-sm">
              <div className="relative aspect-[4/3] w-full overflow-hidden bg-[#F3F0E8]">
                <Image
                  ...
                  alt="Abhijeet Kumar at desk in Snabbit operations office"
                  fill
                  sizes="(max-width: 768px) 100vw, 33vw"
              ...
              <figcaption className="mt-3 px-1 text-xs text-[#66645E] leading-normal flex items-start justify-between gap-2">
                <span>
                  Operations workstation at Snabbit: translating daily telemetry into category roadmaps.
                </span>
                <span className="font-mono text-[10px] text-[#A7472A] shrink-0">
                  Bengaluru
                </span>
            ...
            <figure className="bg-[#FAF8F2] border border-[#C8C3B8] p-3 rounded-sm">
              <div className="relative aspect-[4/3] w-full overflow-hidden bg-[#F3F0E8]">
                <Image
                  src="/images/flight-night-view.png"
                  alt="Aerial view from airplane window at night over illuminated city"
                  fill
                  sizes="(max-width: 768px) 100vw, 33vw"
                  className="object-cover"
                />
              ...
              <figcaption className="mt-3 px-1 text-xs text-[#66645E] leading-normal flex items-start justify-between gap-2">
                <span>
                  Night flight across Indian cities: moving between operating hubs, diligence, and field sites.
                </span>
                <span className="font-mono text-[10px] text-[#A7472A] shrink-0">
                  Transit
                </span>
